...
namespace Vet_Clinica
{
    public partial class BookDoctor : Form
    {
        ...
        private void fillTimeBox()
        {
            ...
            comboBox1.Items.Add("08:00-08:30");
            comboBox1.Items.Add("08:30-09:00");
        ...
        private bool checkPet(string ID_Pet)
        {
                    ...
                    if (checkPet(ID_Pet) == true)
                    {
                        ...
                        if(checkTime(day))
                        {
                            ...
                            if (checkInsert())
                            {
                                ...
                                {
                                    database.OpenConnection();
                                    string query = $"INSERT INTO Card (ID_Pet,ID_Doctor,Complaints,Dat,Tim) VALUES({int.Parse(ID_Pet)},{selected_ID_Doctor},'{complaints}','{date}','{time}');";
        ...
        private bool checkForCompl()
        {
            ...
            cmd1.CommandType = CommandType.StoredProcedure;
            cmd1.Parameters.AddWithValue("PET_ID", id);
